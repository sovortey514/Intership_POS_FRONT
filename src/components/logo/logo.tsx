...
export const Logo = forwardRef<HTMLDivElement, LogoProps>(
  (
    ...
    const singleLogo = (
      ...
      >
        <img
          src="https://images.pexels.com/photos/27820542/pexels-photo-27820542/free-photo-of-a-yellow-sign-with-a-crown-on-it.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load"
          alt="Logo"
          style={{
            width: '50px',
            height: '50px',
